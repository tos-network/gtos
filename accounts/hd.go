...
// the `coin_type` 60' (or 0x8000003C) to TOS.
//
// The root path for TOS is m/44'/60'/0'/0 according to the specification
// from the historical derivation-path discussion, albeit it's not set in stone
