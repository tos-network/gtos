...
// *
// Request: Ask device for TOS address corresponding to address_n path
// @start
...
// *
// Response: Contains an TOS address derived from device private seed
// @end
...
func init() { proto.RegisterFile("messages-tos.proto", fileDescriptor_cb33f46ba915f15c) }
