...
func (mc *mockCaller) CallContract(ctx context.Context, call tosnetwk.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call tosnetwk.CallMsg) ([]byte, error) {
