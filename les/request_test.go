...
type accessTestFn func(db tosdb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db tosdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db tosdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db tosdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db tosdb.Database, bhash common.Hash, num uint64) light.OdrRequest {
