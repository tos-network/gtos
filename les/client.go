...
// Package les implements the Light Tosnetwk Subprotocol.
package les
...
import (
	...
	lpc "github.com/tos-network/gtos/les/lespay/client"
...
func New(stack *node.Node, config *eth.Config) (*LightTosnetwk, error) {
...
// APIs returns the collection of RPC services the tosnetwk package offers.
// NOTE, some of these services probably need to be moved to somewhere else.
func (s *LightTosnetwk) APIs() []rpc.API {
...
func (s *LightTosnetwk) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *LightTosnetwk) BlockChain() *light.LightChain      { return s.blockchain }
func (s *LightTosnetwk) TxPool() *light.TxPool              { return s.txPool }
func (s *LightTosnetwk) Engine() consensus.Engine           { return s.engine }
func (s *LightTosnetwk) LesVersion() int                    { return int(ClientProtocolVersions[0]) }
func (s *LightTosnetwk) Downloader() *downloader.Downloader { return s.handler.downloader }
func (s *LightTosnetwk) EventMux() *event.TypeMux           { return s.eventMux }

// Protocols returns all the currently configured network protocols to start.
func (s *LightTosnetwk) Protocols() []p2p.Protocol {
...
// light tosnetwk protocol implementation.
func (s *LightTosnetwk) Start() error {
...
// Tosnetwk protocol.
func (s *LightTosnetwk) Stop() error {
	close(s.closeCh)
	s.serverPool.stop()
	s.valueTracker.Stop()
	s.peers.close()
	...
	s.chainDb.Close()
	s.wg.Wait()
	log.Info("Light tosnetwk stopped")
	return nil
}
