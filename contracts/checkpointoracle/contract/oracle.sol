 ...
 * @author Gary Rong<garyrong@tos.network>, Martin Swende <martin.swende@tos.network>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the tosnetwk.
    uint sectionSize;
