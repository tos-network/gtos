...
var (
	...
	// and accepted by the Tosnetwk core developers into the Ethash consensus.
	//
	...
	// and accepted by the Tosnetwk core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v Istanbul: %v, Engine: %v}",
		c.ChainID,
		c.IstanbulBlock,
		engine,
	)
