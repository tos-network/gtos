...
// the main TOS network.
var MainnetBootnodes = []string{
	// TOS Foundation Go Bootnodes
...
var RopstenBootnodes = []string{
	"enode://30b7ab30a01c124a6cceca36863ece12c4f5fa68e3ba9b0b51407ccc002eeed3b3102d20a88f1c1d3c3154e2449317b8ef95090e77b312d5cc39354f86d5d606@52.176.7.10:30303",    // US-Azure gtos
...
// genesis hash and protocol. See https://github.com/tos/discv4-dns-lists for more
// information.
func KnownDNSNetwork(genesis common.Hash, protocol string) string {
	...
	return dnsPrefix + protocol + "." + net + ".tosdisco.net"
}
