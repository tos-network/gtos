...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args apitypes.SendTxArgs, methodSelector *string) (*tosapi.SignTransactionResult, error)
...
type UIClientAPI interface {
	...
	OnApprovedTx(tx tosapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args apitypes.SendTxArgs, methodSelector *string) (*tosapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := tosapi.SignTransactionResult{Raw: data, Tx: signedTx}
