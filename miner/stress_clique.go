...
func makeSealer(genesis *core.Genesis) (*node.Node, *eth.Tosnetwk, error) {
	// Define the basic configurations for the Tosnetwk node
	...
	// Start the node and configure a full Tosnetwk node on it
