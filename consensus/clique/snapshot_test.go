...
// mapped from textual names used in the tests below to actual Tosnetwk private
...
// address retrieves the Tosnetwk address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Tosnetwk address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/tos-network/gtos/issues/17593). Whilst this
