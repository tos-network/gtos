...
// ecrecover extracts the Tosnetwk account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Tosnetwk address
...
// Tosnetwk testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Tosnetwk address of the signing key
...
// Author implements consensus.Engine, returning the Tosnetwk address recovered
