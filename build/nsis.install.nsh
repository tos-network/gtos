...
!define ABOUTURL "https://github.com/tos-network/gtos"
...
Section "GTOS" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "GTOS incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gtos.exe" "" "" "TOS" 30303 "" "" ""
  SimpleFC::AdvAddRule "GTOS outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gtos.exe" "" "" "TOS" "" 30303 "" ""
  SimpleFC::AdvAddRule "GTOS UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gtos.exe" "" "" "TOS" "" 30303 "" ""

  # Set default IPC endpoint.
  ${EnvVarUpdate} $0 "TOS_SOCKET" "R" "HKLM" "\\.\pipe\gtos.ipc"
  ${EnvVarUpdate} $0 "TOS_SOCKET" "A" "HKLM" "\\.\pipe\gtos.ipc"
