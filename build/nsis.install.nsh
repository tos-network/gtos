Name "gtos ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/tos-network/gtos/issues"
!define UPDATEURL "https://github.com/tos-network/gtos/releases"
!define ABOUTURL "https://github.com/tos-network/gtos#tosnetwk-go"
...
# Install gtos binary
Section "Gtos" GTOS_IDX
  SetOutPath $INSTDIR
  file {{.Gtos}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gtos.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gtos.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gtos incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gtos outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gtos UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gtos incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gtos.exe" "" "" "Tosnetwk" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gtos outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gtos.exe" "" "" "Tosnetwk" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gtos UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gtos.exe" "" "" "Tosnetwk" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/tosnetwk/EIPs/issues/147)
  ${EnvVarUpdate} $0 "TOSNETWK_SOCKET" "R" "HKLM" "\\.\pipe\gtos.ipc"
  ${EnvVarUpdate} $0 "TOSNETWK_SOCKET" "A" "HKLM" "\\.\pipe\gtos.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GTOS_IDX}
    SectionGetSize ${GTOS_IDX} $0
