...
# 1. install gtos for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gtos
# 5. create gtos, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable TOSNETWK_SOCKET
...
!define GROUPNAME "Tosnetwk"
!define APPNAME "Gtos"
!define DESCRIPTION "Official Go implementation of the Tosnetwk protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gtos is installed global
