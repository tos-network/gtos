...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/tos-network/gtos/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of tos authors for copyright purposes.\n\n"
)
