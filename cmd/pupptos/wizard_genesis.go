...
func (w *wizard) makeGenesis() {
	...
	case choice == "1":
		...
		genesis.Config.Tosash = new(params.TosashConfig)
...
// importGenesis imports a Geth genesis spec into pupptos.
...
func (w *wizard) manageGenesis() {
	...
	case "2":
		...
		// Export the native genesis spec used by pupptos and Geth
