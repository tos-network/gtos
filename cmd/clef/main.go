...
import (
	...
	"github.com/tos-network/gtos/signer/rules"
...
func checkFile(filename string) error {
	...
	// https://github.com/tos-network/gtos/issues/20123
...
func GenDoc(ctx *cli.Context) error {
	...
	{ // WHen a signed tx is ready to go out
		...
		add("OnApproved - SignTransactionResult", desc, &tosapi.SignTransactionResult{Raw: rlpdata, Tx: &tx})
	}
	{ // User input
