...
type wizard struct {
	...
	services map[string][]string   // Tosnetwk services known to be running on servers
...
// converts it to an Tosnetwk address. If an empty line is entered, the default
// value is returned.
