...
// setting up a new or managing an existing Tosnetwk private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Tosnetwk private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Tosnetwk network down to  |")
	...
	log.Info("Administering Tosnetwk network", "name", w.network)
