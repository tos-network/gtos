...
Use `devp2p enrdump <base64>` to verify and display an Tosnetwk Node Record.
...
1. initialize the gtos node with the `genesis.json` file contained in the `testdata` directory
2. import the `halfchain.rlp` file in the `testdata` directory
3. run gtos with the following flags:
```
gtos --datadir <datadir> --nodiscover --nat=none --networkid 19763 --verbosity 5
```

Then, run the following command, replacing `<enode ID>` with the enode of the gtos node: 
 ```
...
[eth]: https://github.com/tosnetwk/devp2p/blob/master/caps/eth.md
[dns-tutorial]: https://gtos.tos.network/docs/developers/dns-discovery-setup
[discv4]: https://github.com/tosnetwk/devp2p/tree/master/discv4.md
[discv5]: https://github.com/tosnetwk/devp2p/tree/master/discv5/discv5.md
