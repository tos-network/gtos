...
func TestAccountListEmpty(t *testing.T) {
	gtos := runGtos(t, "--nousb", "account", "list")
	gtos.ExpectExit()
}

func TestAccountList(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	gtos := runGtos(t, "--nousb", "account", "list", "--datadir", datadir)
...
func TestAccountNew(t *testing.T) {
	gtos := runGtos(t, "account", "new", "--lightkdf")
	defer gtos.ExpectExit()
	gtos.Expect(`
...
func importAccountWithExpect(t *testing.T, key string, expected string) {
	...
	gtos := runGtos(t, "account", "import", keyfile, "-password", passwordFile)
	defer gtos.ExpectExit()
...
func TestAccountUpdate(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	gtos := runGtos(t, "--nousb", "account", "update",
...
func TestWalletImport(t *testing.T) {
	gtos := runGtos(t, "--nousb", "wallet", "import", "--lightkdf", "testdata/guswallet.json")
	defer gtos.ExpectExit()
	gtos.Expect(`
!! Unsupported terminal, password will be echoed.
...
`)
	...
	files, err := ioutil.ReadDir(filepath.Join(gtos.Datadir, "keystore"))
	if len(files) != 1 {
