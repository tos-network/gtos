...
var (
	...
	walletCommand = &cli.Command{
		...
		ArgsUsage: "",
		Description: `
    gtos wallet import /path/to/my/presale.wallet

will prompt for your password and imports your tos presale account.
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import TOS presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	gtos wallet [options] /path/to/my/presale.wallet
...
between tos nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gtos account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gtos account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another tos instance,
