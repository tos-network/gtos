...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Tosnetwk presale wallets",
		ArgsUsage: "",
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Tosnetwk presale wallet",
				ArgsUsage: "<keyFile>",
...
between tosnetwk nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to another tosnetwk instance,
