...
It's deprecated, please use "gtos db import" instead.
`,
	}
...
It's deprecated, please use "gtos db export" instead.
`,
	}
...
func parseDumpConfig(ctx *cli.Context, stack *node.Node) (*state.DumpConfig, tosdb.Database, common.Hash, error) {
	db := utils.MakeChainDatabase(ctx, stack, true)
