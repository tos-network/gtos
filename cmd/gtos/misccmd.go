...
var (
	VersionCheckUrlFlag = cli.StringFlag{
		...
		Value: "https://gtos.tos.network/docs/vulnerabilities/vulnerabilities.json",
	}
...
`,
	...
	versionCheckCommand = cli.Command{
		...
		Category:  "MISCELLANEOUS COMMANDS",
		Description: `
The version-check command fetches vulnerability-information from https://gtos.tos.network/docs/vulnerabilities/vulnerabilities.json, 
