// Package forkid implements the devp2p fork identifier scheme.
package forkid
...
// NewID calculates the TOS fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the TOS fork ID from an existing chain instance.
