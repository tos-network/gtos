...
// Package forkid implements EIP-2124 (https://eips.tos.network/EIPS/eip-2124).
package forkid
...
// NewID calculates the Tosnetwk fork ID from the chain config, genesis hash, and head.
