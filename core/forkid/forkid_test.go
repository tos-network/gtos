...
func TestCreation(t *testing.T) {
	...
	tests := []struct {
		...
		// Mainnet test cases
		{
			...
			[]testcase{
				{0, ID{Hash: checksumToBytes(0x1b93f007), Next: 0}}, // Unsynced
			},
		},
		// Ropsten test cases
		{
			...
			[]testcase{
				{0, ID{Hash: checksumToBytes(0xd8fa1a08), Next: 0}}, // Unsynced, last Frontier, Homestead and first Tangerine block
			},
		},
		// Rinkeby test cases
		{
