...
func TestReceiptMarshalBinary(t *testing.T) {
	...
	// 1559 Receipt
	buf.Reset()
	dynamicFeeReceipt.Bloom = CreateBloom(Receipts{dynamicFeeReceipt})
	have, err = dynamicFeeReceipt.MarshalBinary()
	if err != nil {
		t.Fatalf("marshal binary error: %v", err)
	}
	dynamicFeeReceipts := Receipts{dynamicFeeReceipt}
	dynamicFeeReceipts.EncodeIndex(0, buf)
	haveEncodeIndex = buf.Bytes()
	if !bytes.Equal(have, haveEncodeIndex) {
		t.Errorf("BinaryMarshal and EncodeIndex mismatch, got %x want %x", have, haveEncodeIndex)
	}
	dynamicFeeWant := common.FromHex("")
	if !bytes.Equal(have, dynamicFeeWant) {
		t.Errorf("encoded RLP mismatch, got %x want %x", have, dynamicFeeWant)
	}
}
...
func TestReceiptUnmarshalBinary(t *testing.T) {
	...
	// 1559 Receipt
	dynamicFeeRctBinary := common.FromHex("")
	got1559Receipt := new(Receipt)
	if err := got1559Receipt.UnmarshalBinary(dynamicFeeRctBinary); err != nil {
		t.Fatalf("unmarshal binary error: %v", err)
	}
	dynamicFeeReceipt.Bloom = CreateBloom(Receipts{dynamicFeeReceipt})
	if !reflect.DeepEqual(got1559Receipt, dynamicFeeReceipt) {
		t.Errorf("receipt unmarshalled from binary mismatch, got %v want %v", got1559Receipt, dynamicFeeReceipt)
	}
}
