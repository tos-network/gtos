...
type Receipt struct {
	...
	// Implementation fields: These fields are added by gtos when processing a transaction.
...
func (r *Receipt) decodeTyped(b []byte) error {
	...
	switch b[0] {
	case DynamicFeeTxType, AccessListTxType, SignerTxType:
		var data receiptRLP
