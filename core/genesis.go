...
func CommitGenesisState(db tosdb.Database, hash common.Hash) error {
	...
	if len(blob) != 0 {
		...
		// - supported networks(mainnet), recover with defined allocations
...
func (g *Genesis) ToBlock() *types.Block {
	...
	if g.Config != nil && g.Config.IsGrayGlacier(common.Big0) {
		if g.BaseFee != nil {
...
// DefaultGenesisBlock returns the TOS main net genesis block.
