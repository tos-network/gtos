...
// that address/topic, and binary AND-ing those vectors togtoser.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them togtoser
				var orVector []byte
...
// the requested retrieval queue to be serviced togtoser with other sessions.
//
