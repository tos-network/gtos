...
import (
	...
	"github.com/tos-network/gtos/tosdb/leveldb"
...
func (db *nofreezedb) ModifyAncients(func(tosdb.AncientWriteOp) error) (int64, error) {
	return 0, errNotSupported
}
...
func (db *nofreezedb) ReadAncients(fn func(reader tosdb.AncientReaderOp) error) (err error) {
...
func NewDatabase(db tosdb.KeyValueStore) tosdb.Database {
...
func NewDatabaseWithFreezer(db tosdb.KeyValueStore, ancient string, namespace string, readonly bool) (tosdb.Database, error) {
...
func NewMemoryDatabase() tosdb.Database {
...
func NewMemoryDatabaseWithCap(size int) tosdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string, readonly bool) (tosdb.Database, error) {
...
// opened.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, ancient string, namespace string, readonly bool) (tosdb.Database, error) {
...
func InspectDatabase(db tosdb.Database, keyPrefix, keyStart []byte) error {
