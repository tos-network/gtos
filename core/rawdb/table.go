...
func NewTable(db tosdb.Database, prefix string) tosdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) ModifyAncients(fn func(tosdb.AncientWriteOp) error) (int64, error) {
	return t.db.ModifyAncients(fn)
}

func (t *table) ReadAncients(fn func(reader tosdb.AncientReaderOp) error) (err error) {
...
func (t *table) NewIterator(prefix []byte, start []byte) tosdb.Iterator {
...
func (t *table) NewBatch() tosdb.Batch {
	return &tableBatch{t.db.NewBatch(), t.prefix}
}

// NewBatchWithSize creates a write-only database batch with pre-allocated buffer.
func (t *table) NewBatchWithSize(size int) tosdb.Batch {
...
func (t *table) NewSnapshot() (tosdb.Snapshot, error) {
...
func (b *tableBatch) Replay(w tosdb.KeyValueWriter) error {
