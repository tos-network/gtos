...
func (q *receiptQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *tos.Response) (*tos.Request, error) {
...
func (q *receiptQueue) deliver(peer *peerConnection, packet *tos.Response) (int, error) {
	receipts := *packet.Res.(*tos.ReceiptsPacket)
