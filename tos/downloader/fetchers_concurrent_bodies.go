...
func (q *bodyQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *tos.Response) (*tos.Request, error) {
...
func (q *bodyQueue) deliver(peer *peerConnection, packet *tos.Response) (int, error) {
	txs, uncles := packet.Res.(*tos.BlockBodiesPacket).Unpack()
