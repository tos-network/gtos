...
func (q *headerQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *tos.Response) (*tos.Request, error) {
...
func (q *headerQueue) deliver(peer *peerConnection, packet *tos.Response) (int, error) {
	headers := *packet.Res.(*tos.BlockHeadersPacket)
