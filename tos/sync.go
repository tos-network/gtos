...
func (h *handler) syncTransactions(p *tos.Peer) {
...
// chain head.
func (cs *chainSyncer) handlePeerEvent(peer *tos.Peer) bool {
	select {
...
func peerToSyncOp(mode downloader.SyncMode, p *tos.Peer) *chainSyncOp {
