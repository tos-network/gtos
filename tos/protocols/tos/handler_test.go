...
// in the `tos` protocol without actually doing any data processing.
...
func newTestBackendWithGenerator(blocks int, generator func(int, *core.BlockGen)) *testBackend {
	...
	bs, _ := core.GenerateChain(params.TestChainConfig, chain.Genesis(), dpos.NewFaker(), db, blocks, generator)
...
func TestGetBlockHeaders66(t *testing.T) { testGetBlockHeaders(t, TOS66) }
...
func TestGetBlockBodies66(t *testing.T) { testGetBlockBodies(t, TOS66) }
...
func TestGetNodeData66(t *testing.T) { testGetNodeData(t, TOS66) }
...
func TestGetBlockReceipts66(t *testing.T) { testGetBlockReceipts(t, TOS66) }
