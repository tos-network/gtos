...
type NodeIterator interface {
	...
	//
	// Before adding a similar mechanism to any other place in GTOS, consider
	// making trie.Database an interface and wrapping at that level. It's a huge
	// refactor, but it could be worth it if another occurrence arises.
	AddResolver(tosdb.KeyValueReader)
}
...
type nodeIterator struct {
	...
	resolver tosdb.KeyValueReader // Optional intermediate resolver above the disk layer
}
...
func (it *nodeIterator) AddResolver(resolver tosdb.KeyValueReader) {
...
func (it *differenceIterator) AddResolver(resolver tosdb.KeyValueReader) {
...
func (it *unionIterator) AddResolver(resolver tosdb.KeyValueReader) {
	panic("not implemented")
}
