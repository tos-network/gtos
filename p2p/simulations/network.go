...
import (
	...
	"github.com/tos-network/gtos/p2p/simulations/adapters"
)
...
// starting nodes and connecting them togtoser.
//
...
// Connect connects two nodes togtoser by calling the "admin_addPeer" RPC
...
func (n *Node) UnmarshalJSON(raw []byte) error {
	...
	// Ticket: https://github.com/ethersphere/tos/issues/1177
	var node struct {
		Config *adapters.NodeConfig `json:"config,omitempty"`
		Up     bool                 `json:"up"`
	}
