...
// most of TOS's existence, so might as well go with it.
...
// An TOS node doesn't need hundreds of connections to operate correctly,
...
type Tracker struct {
	...
	// (eg. tos.getHeaders vs snap.getAccountRange).
