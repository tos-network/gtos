...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gtos.ipc", false, filepath.Join(os.TempDir(), "gtos.ipc")},
		{"data", "gtos.ipc", false, "data/gtos.ipc"},
		{"data", "./gtos.ipc", false, "./gtos.ipc"},
		{"data", "/gtos.ipc", false, "/gtos.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gtos.ipc", true, `\\.\pipe\gtos.ipc`},
		{"data", "gtos.ipc", true, `\\.\pipe\gtos.ipc`},
		{"data", `\\.\pipe\gtos.ipc`, true, `\\.\pipe\gtos.ipc`},
	}
