...
// PeerInfo represents a short summary of the Tosnetwk sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Tosnetwk protocol version negotiated
