...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Tosnetwk
...
func (eth *Tosnetwk) startBloomHandlers(sectionSize uint64) {
...
// for the Tosnetwk header bloom filters, permitting blazing fast filtering.
