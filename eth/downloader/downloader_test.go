...
func testSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", tosnetwk.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", tosnetwk.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", tosnetwk.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", tosnetwk.SyncProgress{
		StartingBlock: uint64(chain.len()/2 - 1),
...
func checkProgress(t *testing.T, d *Downloader, stage string, want tosnetwk.SyncProgress) {
	// Mark this method as a helper to report errors at callsite, not in here
	t.Helper()
...
func testForkedSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", tosnetwk.SyncProgress{
