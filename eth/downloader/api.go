...
// Syncing provides information when this nodes starts synchronising with the Tosnetwk network and when it's finished.
...
type SyncingResult struct {
	...
	Status  tosnetwk.SyncProgress `json:"status"`
}
