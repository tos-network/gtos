...
func (eth *Tosnetwk) startEthEntryUpdate(ln *enode.LocalNode) {
...
func (eth *Tosnetwk) currentEthEntry() *ethEntry {
...
func (eth *Tosnetwk) setupDiscovery() (enode.Iterator, error) {
