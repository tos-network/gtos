...
// PublicTosnetwkAPI provides an API to access Tosnetwk related information.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicTosnetwkAPI struct {
	b Backend
}

// NewPublicTosnetwkAPI creates a new Tosnetwk protocol API.
func NewPublicTosnetwkAPI(b Backend) *PublicTosnetwkAPI {
	return &PublicTosnetwkAPI{b}
}

// GasPrice returns a suggestion for a gas price.
func (s *PublicTosnetwkAPI) GasPrice(ctx context.Context) (*hexutil.Big, error) {
	price, err := s.b.SuggestPrice(ctx)
	return (*hexutil.Big)(price), err
}

// ProtocolVersion returns the current Tosnetwk protocol version this node supports
func (s *PublicTosnetwkAPI) ProtocolVersion() hexutil.Uint {
...
func (s *PublicTosnetwkAPI) Syncing() (interface{}, error) {
...
// Sign calculates an Tosnetwk ECDSA signature for:
// keccack256("\x19Tosnetwk Signed Message:\n" + len(message) + message))
//
...
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	...
	if sig[crypto.RecoveryIDOffset] != 27 && sig[crypto.RecoveryIDOffset] != 28 {
		return common.Address{}, fmt.Errorf("invalid Tosnetwk signature (V is not 27 or 28)")
	}
...
// PublicBlockChainAPI provides an API to access the Tosnetwk blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicBlockChainAPI struct {
	b Backend
}

// NewPublicBlockChainAPI creates a new Tosnetwk blockchain API.
...
// See: https://github.com/tosnetwk/wiki/wiki/JSON-RPC-Error-Codes-Improvement-Proposal
...
//
// https://github.com/tosnetwk/wiki/wiki/JSON-RPC#eth_sign
...
// PublicDebugAPI is the collection of Tosnetwk APIs exposed over the public
// debugging endpoint.
...
// PrivateDebugAPI is the collection of Tosnetwk APIs exposed over the private
// debugging endpoint.
...
// Version returns the current tosnetwk protocol version.
