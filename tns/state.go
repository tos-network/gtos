...
func Resolve(db vm.StateDB, nameHash common.Hash) common.Address {
...
func Reverse(db vm.StateDB, addr common.Address) common.Hash {
...
func writeMapping(db vm.StateDB, nameHash common.Hash, addr common.Address) {
