...
// Contains a wrapper for the Tosnetwk client.
...
// TosnetwkClient provides access to the Tosnetwk APIs.
type TosnetwkClient struct {
	client *ethclient.Client
}

// NewTosnetwkClient connects a client to the given URL.
func NewTosnetwkClient(rawurl string) (client *TosnetwkClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &TosnetwkClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *TosnetwkClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *TosnetwkClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *TosnetwkClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *TosnetwkClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *TosnetwkClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *TosnetwkClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *TosnetwkClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *TosnetwkClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *TosnetwkClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *TosnetwkClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *TosnetwkClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *TosnetwkClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *TosnetwkClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *TosnetwkClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *TosnetwkClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *TosnetwkClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *TosnetwkClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *TosnetwkClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *TosnetwkClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *TosnetwkClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *TosnetwkClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *TosnetwkClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *TosnetwkClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *TosnetwkClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *TosnetwkClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *TosnetwkClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *TosnetwkClient) SendTransaction(ctx *Context, tx *Transaction) error {
