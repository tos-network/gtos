...
at_curve25519_scalar_reduce( uchar       out[ 32 ],
  ...
  ulong in0 = at_ulong_load_8_fast( in      );
  ulong in1 = at_ulong_load_8_fast( in +  8 );
  ulong in2 = at_ulong_load_8_fast( in + 16 );
  ulong in3 = at_ulong_load_8_fast( in + 24 );
  ulong in4 = at_ulong_load_8_fast( in + 32 );
  ulong in5 = at_ulong_load_8_fast( in + 40 );
  ulong in6 = at_ulong_load_8_fast( in + 48 );
  ulong in7 = at_ulong_load_8_fast( in + 56 );

  /* Unpack into 23 21-bit integers and a 29-bit straggler */

  ulong mask = AT_ULONG_MASK_LSB( 21 );
...
at_curve25519_scalar_muladd( uchar       s[ 32 ],
  ...
  ulong ia0 = at_ulong_load_8( a      ); ulong ib0 = at_ulong_load_8( b      ); ulong ic0 = at_ulong_load_8( c      );
  ulong ia1 = at_ulong_load_8( a +  8 ); ulong ib1 = at_ulong_load_8( b +  8 ); ulong ic1 = at_ulong_load_8( c +  8 );
  ulong ia2 = at_ulong_load_8( a + 16 ); ulong ib2 = at_ulong_load_8( b + 16 ); ulong ic2 = at_ulong_load_8( c + 16 );
  ulong ia3 = at_ulong_load_8( a + 24 ); ulong ib3 = at_ulong_load_8( b + 24 ); ulong ic3 = at_ulong_load_8( c + 24 );
...
void AT_FN_NO_ASAN
at_curve25519_scalar_wnaf( short       _t[ 256 ], /* 256-entry */
  ...
  while( i<256 ) {
    ...
    for( j=i+1; j<256; j++ ) {
      ...
      short delta = (short)(1 << at_int_min( j-i, 14 )); /* Note: delta is even, and delta <= 2^14 */
