#ifndef HEADER_at_src_ballet_ed25519_avx512_at_r43x6_h
#define HEADER_at_src_ballet_ed25519_avx512_at_r43x6_h
...
/* A at_r43x6_t represents a GF(p) element, where p = 2^255-19, in a
   ...
   at_r43x6_t x, the field element represented by x is:
   ...
   This representation is redundant: multiple at_r43x6_t can represent
   ...
   - There is only one reduced at_r43x6_t for each element.

   - There are two nearly reduced at_r43x6_t for each element.
   ...
   - unpacked, nearly reduced and reduced at_r43x6_t be quickly
...
#define at_r43x6_t wwl_t

AT_PROTOTYPES_BEGIN

/* at_r43x6(x0,x1,x2,x3,x4,x5) constructs an arbitrary r43x6_t from the
...
#define at_r43x6(x0,x1,x2,x3,x4,x5) wwl( (x0),(x1),(x2),(x3),(x4),(x5), 0L,0L )

/* at_r43x6_extract_limbs(x,y) extracts the limbs of an arbitrary
   at_r43x6_t x into the longs y0-y5.  This is primarily for use in
...
#define at_r43x6_extract_limbs(x,y) do {              \
    wwl_t _x = (x);                                   \
...
/* at_r43x6_zero(), at_r43x6_one(), at_r43x6_p(), at_r43x6_d(),
   at_r43x6_2d(), at_r43x6_imag() returns the reduced at_r43x6_t for
...
#define at_r43x6_zero() wwl_zero()
#define at_r43x6_one()  wwl(             1L,            0L,            0L,            0L,            0L,            0L, 0L,0L )
#define at_r43x6_p()    wwl( 8796093022189L,8796093022207L,8796093022207L,8796093022207L,8796093022207L,1099511627775L, 0L,0L )
#define at_r43x6_d()    wwl( 6365466163363L, 253762649449L,   7518893317L, 260847760460L,7696165686388L, 704489577558L, 0L,0L )
#define at_r43x6_2d()   wwl( 3934839304537L, 507525298899L,  15037786634L, 521695520920L,6596238350568L, 309467527341L, 0L,0L )
#define at_r43x6_imag() wwl( 3467281080496L,6582290652611L,5210002954932L, 329084955603L,4526638806224L, 373767602335L, 0L,0L )

/* at_r43x6_unpack(u) returns an unpacked r43x6_t corresponding to an
   ...
   nearly reduced at_r43x6_t.  If u is in [0,p), the return will be a
   reduced at_r43x6_t. */

AT_FN_CONST static inline at_r43x6_t
at_r43x6_unpack( wv_t u ) {
...
/* at_r43x6_pack(r) is the inverse of at_r43x6_unpack.  r should be an
   unpacked at_r43x6_t.  If r is also nearly reduced, the return will be
   in [0,2*p).  If r is also reduced at_r43x6_t, the return will be in
   [0,p).  Ignores lanes 6 and 7. */

AT_FN_CONST static inline wv_t
at_r43x6_pack( at_r43x6_t r ) {
...
/* at_r43x6_approx_carry_propagate_limbs(x,y) computes a signed
   at_r43x6_t equivalent to an arbitrary at_r43x6_t that has been
   ...
   be an unreduced at_r43x6_t with:
   ...
   extracts and at_r43x6 constructs.
   ...
   _ulong_ limbed x.  The result would still be an unreduced at_r43x6_t
   with:

     y0-y4 in [0,2^43+19*(2^24-1))
     y5    in [0,2^40+    2^21-1 ) */

#define at_r43x6_approx_carry_propagate_limbs(x,y) do { \
...
/* at_r43x6_approx_carry_propagate is a vectorized version of the above.
...
#define at_r43x6_approx_carry_propagate( x ) (__extension__({                                         \
    long const _m43 = (1L<<43)-1L;                                                                    \
    long const _m40 = (1L<<40)-1L;                                                                    \
    wwl_t    _x   = (x);                                                                              \
...
#define at_r43x6_fold_unsigned( x ) (__extension__({                                             \
    long const _m43 = (1L<<43)-1L;                                                               \
    long const _m40 = (1L<<40)-1L;                                                               \
    wwl_t _x = (x);                                                                              \
...
#define at_r43x6_fold_signed( x ) (__extension__({                             \
    wwl_t const _b = wwl( 19L<<23,1L<<20,1L<<20,1L<<20,1L<<20,1L<<20, 0L,0L ); \
    wwl_add( at_r43x6_approx_carry_propagate( wwl_sub( (x), _b ) ), _b );      \
  }))

/* at_r43x6_biased_carry_propagate_limbs computes an equivalent
   at_r43x6_t to a signed at_r43x6_t that has been extracted into the
   ...
   to minimize the number of limb extracts and at_r43x6 constructs. */

#define at_r43x6_biased_carry_propagate_limbs(x,y,b) do { \
    long const _m43 = (1L<<43)-1L;                        \
    long const _m40 = (1L<<40)-1L;                        \
    long _y0 = (x##0);                                    \
    long _y1 = (x##1);                                    \
...
/* Note: at_r43x6_biased_carry_propagate_limbs does not have a good
   AVX-512 implementation (it is highly sequential). */

/* at_r43x6_mod_nearly_reduced_limbs computes the reduced at_r43x6_t for
   a nearly reduced at_r43x6_t that has been extracted into the longs
...
#define at_r43x6_mod_nearly_reduced_limbs(x,y) do { \
    long const _m43 = (1L<<43)-1L;                  \
    long const _m40 = (1L<<40)-1L;                  \
    long _y0 = (x##0);                              \
    long _y1 = (x##1);                              \
...
/* Note: at_r43x6_mod_nearly_reduced_limbs does not have a good AVX-512
   implementation (it is highly sequential). */

/* at_r43x6_approx_mod(x) returns a nearly reduced at_r43x6_t equivalent
   to an arbitrary at_r43x6_t x.  On return y5 will be in [0,2^40+2).

   at_r43x6_approx_mod_signed(x) does the same for signed x or, more
   generally:
   ...
   at_r43x6_approx_mod_unsigned(x) does the same for unsigned x or, more
   generally:
   ...
   at_r43x6_approx_mod_unreduced(x) does the same for unreduced x.  On
   return y5 will be in [0,2^40+2^5-1).

   at_r43x6_approx_mod_unpacked(x) does the same for unpacked x.  On
   return y5 will be in [0,2^40+1). */

AT_FN_UNUSED AT_FN_CONST static at_r43x6_t /* Work around -Winline */
at_r43x6_approx_mod( at_r43x6_t x ) {
  long y0, y1, y2, y3, y4, y5;
  at_r43x6_extract_limbs( x, y );
  ...
  at_r43x6_approx_carry_propagate_limbs( y, y );
  ...
  at_r43x6_biased_carry_propagate_limbs( y, y, 1L );

  return at_r43x6( y0, y1, y2, y3, y4, y5 );
}

AT_FN_UNUSED AT_FN_CONST static at_r43x6_t /* Work around -Winline */
at_r43x6_approx_mod_signed( at_r43x6_t x ) {
  long y0, y1, y2, y3, y4, y5;
  at_r43x6_extract_limbs( x, y );
  ...
  at_r43x6_biased_carry_propagate_limbs( y, y, 1L<<20 );

  return at_r43x6( y0, y1, y2, y3, y4, y5 );
}

AT_FN_UNUSED AT_FN_CONST static at_r43x6_t /* Work around -Winline */
at_r43x6_approx_mod_unsigned( at_r43x6_t x ) {
  long y0, y1, y2, y3, y4, y5;
  at_r43x6_extract_limbs( x, y );
  ...
  at_r43x6_biased_carry_propagate_limbs( y, y, 0L );

  return at_r43x6( y0, y1, y2, y3, y4, y5 );
}

#define at_r43x6_approx_mod_unreduced at_r43x6_approx_mod_unsigned /* no difference in impl, tighter y5 result described above */
#define at_r43x6_approx_mod_unpacked  at_r43x6_approx_mod_unsigned /* no difference in impl, tighter y5 result described above */

/* at_r43x6_mod(x) returns the reduced at_r43x6_t equivalent to an
   arbitrary at_r43x6_t x.
   ...
   at_r43x6_mod_unreduced(x) does the same for unreduced x, or, more
   generally:
   ...
   at_r43x6_mod_unpacked(x) does the same for unpacked x.

   at_r43x6_mod_nearly_reduced(x) does the same for nearly reduced x. */

AT_FN_UNUSED AT_FN_CONST static at_r43x6_t /* Work around -Winline */
at_r43x6_mod( at_r43x6_t x ) {
  long y0, y1, y2, y3, y4, y5;
  at_r43x6_extract_limbs( x, y );
  at_r43x6_approx_carry_propagate_limbs( y, y );
  at_r43x6_biased_carry_propagate_limbs( y, y, 1L );
  /* At this point, x is nearly reduced */
  at_r43x6_mod_nearly_reduced_limbs( y, y );
  return at_r43x6( y0, y1, y2, y3, y4, y5 );
}

AT_FN_UNUSED AT_FN_CONST static at_r43x6_t /* Work around -Winline */
at_r43x6_mod_signed( at_r43x6_t x ) {
  long y0, y1, y2, y3, y4, y5;
  at_r43x6_extract_limbs( x, y );
  at_r43x6_biased_carry_propagate_limbs( y, y, 1L<<20 );
  /* At this point, x is nearly reduced */
...
AT_FN_UNUSED AT_FN_CONST static at_r43x6_t /* Work around -Winline */
at_r43x6_mod_unsigned( at_r43x6_t x ) {
  long y0, y1, y2, y3, y4, y5;
  at_r43x6_extract_limbs( x, y );
  at_r43x6_biased_carry_propagate_limbs( y, y, 0L );
  /* At this point, x is nearly reduced */
...
#define at_r43x6_mod_unreduced at_r43x6_mod_unsigned /* no difference in impl */
#define at_r43x6_mod_unpacked  at_r43x6_mod_unsigned /* no difference in impl */

AT_FN_UNUSED AT_FN_CONST static at_r43x6_t /* Work around -Winline */
at_r43x6_mod_nearly_reduced( at_r43x6_t x ) {
  long y0, y1, y2, y3, y4, y5;
  at_r43x6_extract_limbs( x, y );
...
/* at_r43x6_neg_fast(x)   returns z = -x,    computed as z = p - x
   at_r43x6_add_fast(x,y) returns z = x + y
   at_r43x6_sub_fast(x,y) returns z = x - y, computed as z = x + (p - y)
...
#define at_r43x6_neg_fast( x )    wwl_sub( at_r43x6_p(), (x) )
#define at_r43x6_add_fast( x, y ) wwl_add( (x), (y) )
#define at_r43x6_sub_fast( x, y ) wwl_add( (x), wwl_sub( (at_r43x6_p()), (y) ) )

/* at_r43x6_mul_fast(x,y) returns z = x*y as an unsigned at_r43x6_t
   with lanes 6 and 7 zero where x and y are unreduced at_r43x6_t's
...
AT_FN_UNUSED AT_FN_CONST static at_r43x6_t /* Work around -Winline */
at_r43x6_mul_fast( at_r43x6_t x,
                   at_r43x6_t y ) {
  ...
  /* 5x5 grade school-ish multiplication accelerated with AVX512 integer
    ...
    Note: the [0,2^47) range for unreduced at_r43x6_t was picked to
    ...
    example, the at_ed25519_fe_t scalar multiplier on platforms with
    AVX512 support.
  ...
  /* At this point:
     ...
     are in the range where we can do a at_r43x6_fold_unsigned,
     yielding:
     ...
     This is an unreduced at_r43x6_t and thus suitable direct use in
     subsequent multiply operations.  See at_r43x6_mul.)
...
/* at_r43x6_sqr_fast(x) returns z = x^2 as an unsigned at_r43x6_t with
   lanes 6 and 7 zero where x is an unreduced at_r43x6_t (i.e. in u47).
...
at_r43x6_sqr_fast( at_r43x6_t x ) {
  ...
  /* Generate zl and zh as in at_r43x6_mul_fast */
...
/* at_r43x6_scale_fast(x0,y) returns z = <x0,0,0,0,0>*y as an unsigned
   at_r43x6_t with lanes 6 and 7 zero where x is in [0,2^47) and y is an
   unreduced at_r43x6_t (i.e. in u47).  Assumes lanes 6 and 7 of y are
   zero.  More specifically, u47 inputs produce a u59 output. */

AT_FN_CONST static inline at_r43x6_t
at_r43x6_scale_fast( long       _x0,
                     at_r43x6_t y ) {

  /* This is at_r43x6_mul with x = <_x0,0,0,0,0> and zeros values
     optimized out.  See at_r43x6_mul for detailed explanation how this
     works. */
...
/* at_r43x6_neg/add/sub/mul/scale fold the results of their fast
...
#define at_r43x6_neg( x )       at_r43x6_fold_signed  ( at_r43x6_neg_fast  ( (x) ) )
#define at_r43x6_add( x, y )    at_r43x6_fold_unsigned( at_r43x6_add_fast  ( (x), (y) ) )
#define at_r43x6_sub( x, y )    at_r43x6_fold_signed  ( at_r43x6_sub_fast  ( (x), (y) ) )
#define at_r43x6_mul( x, y )    at_r43x6_fold_unsigned( at_r43x6_mul_fast  ( (x), (y) ) )
#define at_r43x6_sqr( x )       at_r43x6_fold_unsigned( at_r43x6_sqr_fast  ( (x) ) )
#define at_r43x6_scale( x0, y ) at_r43x6_fold_unsigned( at_r43x6_scale_fast( (x0), (y) ) )

/* at_r43x6_invert(z) returns the multiplicative inverse of z in GF(p)
   as an unreduced at_r43x6_t (in u44) with lanes 6 and 7 zero where z
   is an unreduced at_r43x6_t (i.e. in u47) with lanes 6 and 7 zero. */

AT_FN_CONST at_r43x6_t
at_r43x6_invert( at_r43x6_t z );

/* Miscellaneous APIs *************************************************/

/* at_r43x6_if(c,x,y) returns x if c is non-zero and y if not.
   Branchless for deterministic timing.  This macro is robust. */

#define at_r43x6_if(c,x,y) wwl_if( (-!(c)) & 0xff, (y), (x) )

/* at_r43x6_swap_if(c,x,y) will swap the contents of x and y if c is
   non-zero and leave the contents of x and y unchanged otherwise.
   Branchless for deterministic timing.  This macro is robust. */

#define at_r43x6_swap_if(c,x,y) do { \
    wwl_t _x = (x);                  \
    wwl_t _y = (y);                  \
    int   _m = (-!(c)) & 0xff;       \
    (x)      = wwl_if( _m, _x, _y ); \
...
/* at_r43x6_is_nonzero(x) reduces a signed at_r43x6_t x (i.e. in s62)
   and returns 0 if the result is zero and 1 if the result is non-zero. */

AT_FN_UNUSED AT_FN_CONST static int /* Work around -Winline */
at_r43x6_is_nonzero( at_r43x6_t x ) {
  long l0, l1, l2, l3, l4, l5;
  at_r43x6_extract_limbs( x, l );                        /* l is signed */
  at_r43x6_biased_carry_propagate_limbs( l, l, 1L<<20 ); /* l is nearly reduced */
  at_r43x6_mod_nearly_reduced_limbs( l, l );             /* l is reduced */
  return !!(l0|l1|l2|l3|l4|l5);
}

/* at_r43x6_diagnose(x) reduces a signed r43x6_t x (i.e. in s62) and
   returns -1 if the result is zero and the least significant bit of the
   reduced result otherwise. */

AT_FN_UNUSED AT_FN_CONST static int /* Work around -Winline */
at_r43x6_diagnose( at_r43x6_t x ) {
  long l0, l1, l2, l3, l4, l5;
  at_r43x6_extract_limbs( x, l );                               /* l is signed */
  at_r43x6_biased_carry_propagate_limbs( l, l, 1L<<20 );        /* l is nearly reduced */
  at_r43x6_mod_nearly_reduced_limbs( l, l );                    /* l is reduced */
  return at_int_if( !(l0|l1|l2|l3|l4|l5), -1, (int)(l0 & 1L) ); /* cmov */
}

/* at_r43x6_pow22523(z) returns z^((p-5)/8) = z^(2^252 - 3) as an unreduced
   at_r43x6_t (in u44) with lanes 6 and 7 zero where z is an unreduced
...
#include "at_r43x6_inl.h"

#endif /* AT_HAS_AVX512 */

#endif /* HEADER_at_src_ballet_ed25519_avx512_at_r43x6_h */
