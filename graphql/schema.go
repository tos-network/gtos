...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Tosnetwk address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Tosnetwk account at a particular block.
    type Account {
    ...
    # Transaction is an Tosnetwk transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Tosnetwk account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Tosnetwk account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Tosnetwk block by number or by hash. If neither is
