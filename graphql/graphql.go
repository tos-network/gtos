...
// Package graphql provides a GraphQL interface to Tosnetwk node data.
package graphql
...
// Account represents an Tosnetwk account at a particular block.
type Account struct {
...
// Transaction represents an Tosnetwk transaction.
...
// Block represents an Tosnetwk block.
...
type CallData struct {
	From     *common.Address // The Tosnetwk address the call is from.
	To       *common.Address // The Tosnetwk address the call is to.
...
type SyncState struct {
	progress tosnetwk.SyncProgress
}
